...
class GovernanceMetric(BaseModel):
    ...
    compliance_score: float = Field(0.0, ge=0.0, le=100.0, description="Pontuação de Conformidade")
...
class ComplianceAssessment(BaseModel):
    ...
    overall_score: float = Field(..., ge=0.0, le=100.0, description="Pontuação Geral de Compliance")
    framework_scores: Dict[str, float] = Field({}, description="Pontuação por framework de compliance")
